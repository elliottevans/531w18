...
\todo[inline]{In above df, gives you observation process and state (latent) process. In pomp terminology, N is the latent process, Y is the observed process}
...
\begin{center}\scalebox{0.8}{\includegraphics{figure/intro-unnamed-chunk-4-1}} \end{center}
...
\begin{center}\scalebox{0.8}{\includegraphics{figure/intro-parus-first-traj-1}} \end{center}
...
\begin{center}\scalebox{0.8}{\includegraphics{figure/intro-parus-first-traj-vector-1}} \end{center}
...
\item
  ...
  \todo[inline]{For a stochastic latent process, we ``simulate a sample path" whereas for a deterministic latent process, we ``solve for the trajectory."}  
