...
\item
  ...
  \todo[inline]{Profile likelihood gives the same parameter estimate, but the CI it generates is better when the likelihood is multimodal or isn't perfectly smooth.}
\item
