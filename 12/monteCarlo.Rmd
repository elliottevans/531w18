...
An excellent technical reference on Monte Carlo techniques is @robert04.
...
* @robert04 refer to this fact the *fundamental theorem of simulation*.
...
#### Acknowledgement: These notes derive from [notes by Aaron King](http://kingaa.github.io/sbied/pfilter/monteCarlo.html).
